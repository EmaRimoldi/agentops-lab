...
| [`06_swebench_experimental_scaffold/`](06_swebench_experimental_scaffold/) | scaffold | 100-instance input slice plus orchestration code | neutral study config, prompt templates, input slice, implementation code | scaffold only; no SWE-bench results transferred | not an evidence bundle yet |
...
5. [`05_autoresearch_model_routing/`](05_autoresearch_model_routing/) preserves
   imported processed routing/accounting results from the NeurIPS workspace.
